          ...
          <form  method="POST">
                    ...
                    <table class="table table-bordered"><h1 class="mb-4">Turf</h1>
                        ...
                        <tr>
                          ...
                          <td>Turf:</td> <td><label for="lid" name="lid" ><?php echo $row['Turf_id'];?></label></td> <td rowspan="9">photo<img src="./img/<?php echo $row['image'];?>" height="200" width="200" alt=""><br><br>Licence<img src="./img/<?php echo $row['licence'];?>" height="200" width="200" alt=""><br><br><button style="background-color: yellow;" name="submit">Approve</button></td></tr>
