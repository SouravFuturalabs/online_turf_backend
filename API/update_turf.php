...
$rate=$_POST["rate"];
 ...
 $data=mysqli_query($con,"UPDATE `turf_tbl` SET `Turf_name`='$Turf_name',`Turf_location`='$Turf_location',`owner_acc`='$owner_name',`owner_name`='$owner_name',`image`='$filenew',`Owner_email`='$Owner_email',`owner_ph`='$owner_ph',`licence`='$filenew1',`rate`='$rate' WHERE Turf_id='$turf_id'");
